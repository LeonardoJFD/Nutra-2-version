...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton" href="/nutricionista/eventos/crear">
                ...
                <?php foreach($eventos as $evento) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/nutricionista/eventos/editar?id=<?php echo $evento->id; ?>">
                                <i class="fa-solid fa-pencil"></i>
                                Editar
                            </a>

                            <form method="POST" action="/nutricionista/eventos/eliminar" class="table__formulario">
